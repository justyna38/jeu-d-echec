...
class OnlineChess_Piece {
	 ...
	 * Traduit le nom de la pièce en fonction booléen passé en paramètre
	 */
	public function getName(bool $translate = false) :string {
		//TODO
		$tmp = preg_replace("@^OnlineChess_@", "", get_class($this));
...
class OnlineChess_King extends OnlineChess_Piece {
	 ...
	 * @return un tableau des cases control�es par la pi�ce
	 */
